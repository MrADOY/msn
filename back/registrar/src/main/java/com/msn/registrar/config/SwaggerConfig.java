package com.msn.registrar.config;
...
public class SwaggerConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("API de gestion des connexions")
                .description("Cette page contient toutes les descriptions des api du service resgistrar.")
